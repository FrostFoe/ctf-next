  ...
  return (
    <Card className={'bg-background/50 backdrop-blur-[24px] border-border p-6'}>
      <CardTitle className="flex justify-between items-center pb-6 border-border border-b">
        <span className={'text-xl font-medium'}>এই সাবস্ক্রিপশনের পুনরাবৃত্ত পণ্য</span>
      </CardTitle>
      <CardContent className={'p-0 pt-10'}>
        <div className={'grid grid-cols-12'}>
          <div className={'col-span-6'}></div>
          <div className={'flex gap-6 w-full col-span-6'}>
            <div className={'col-span-2 w-full text-base leading-4 font-semibold'}>পরিমাণ</div>
            <div className={'col-span-2 w-full text-base leading-4 font-semibold'}>ট্যাক্স</div>
            <div className={'col-span-2 w-full text-base leading-4 font-semibold text-right'}>
              <span>পরিমাণ</span>
              <span className={'text-secondary text-sm leading-[14px] font-normal'}>(ট্যাক্স ছাড়া)</span>
            </div>
          </div>
          ...
          <div className={'flex flex-col w-full col-span-6 pt-6'}>
            <div className={'flex justify-between py-4 pt-0 border-border border-b'}>
              <div className={'col-span-3 w-full text-base leading-4 text-secondary'}>পরিমাণ</div>
            ...
            <div className={'flex justify-between py-4 border-border border-b'}>
              <div className={'col-span-3 w-full text-base leading-4 text-secondary'}>ট্যাক্স</div>
              <div className={'col-span-3 w-full text-base leading-4 text-right text-secondary'}>
                {parseMoney(subscription?.recurringTransactionDetails?.totals.tax, subscription?.currencyCode)}
              </div>
            </div>
            <div className={'flex justify-between py-4 border-border border-b'}>
              <div className={'col-span-3 w-full text-base leading-4 text-secondary'}>মোট (ট্যাক্সসহ)</div>
