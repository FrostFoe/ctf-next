...
export function SubscriptionHeader({ subscription }: Props) {
  ...
  const frequency =
    subscription.billingCycle.frequency === 1
      ...
      : `প্রতি ${subscription.billingCycle.frequency} ${subscription.billingCycle.interval} অন্তর`;
  ...
  return (
    <div className={'flex justify-between items-start sm:items-center flex-col sm:flex-row mb-6 sm:mb-0'}>
      <div className={'flex flex-col w-full'}>
        ...
        <div className={'text-secondary text-base leading-5 pb-8'}>শুরুর তারিখ: {formattedStartedDate}</div>
      </div>
      <div>
